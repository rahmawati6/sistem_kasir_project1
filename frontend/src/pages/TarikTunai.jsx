...
const emptyForm = { nomor_rekening: '', nama_penerima: '', nomor_hp: '', jenis_nasabah: 'internal', nominal_tarik: '' }
...
export default function TarikTunai() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await api.post('/tarik-tunai', { ...form, nominal_tarik: parseNominalInput(form.nominal_tarik) })
      ...
      <section className="brilink-table-panel">
        ...
        <div className="brilink-table-wrap">
          <table className="brilink-table">
            <thead><tr><th>Kode</th><th>Tanggal</th><th>Penerima</th><th>Nasabah</th><th>Nominal</th><th>Admin</th><th>Total</th><th>Status</th></tr></thead>
            <tbody>{data.map(t => (
              <tr key={t.id}>
